...
public class MainWindow extends javax.swing.JFrame {
	...
	*/
	...
	public MainWindow(Agent_GUI_Java myAgent) {
		super();
	...
	public void addResult(String agentName, String agentParams, String error) {
		resultsTableModel.addRow(new Object[]{agentName, agentParams, error});
			...
			setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
			{
				...
				jPanel1.setPreferredSize(new java.awt.Dimension(617, 397));
				{
					...
					mainPane.setBounds(10, 14, 591, 308);
					{
						...
						{
							ComboBoxModel agentClass1Model = 
						...
						{
							ComboBoxModel agentClass2Model = 
								new DefaultComboBoxModel();
	...
	private void startButtonMouseClicked(MouseEvent evt) {
		...
		ge.addParameter(new Object[][]{{agentClass1.getSelectedItem(), agentParams1.getText()},
